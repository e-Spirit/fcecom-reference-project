...
const interactiveVideoTemplate = document.createElement('template');
interactiveVideoTemplate.innerHTML = /* html */ `
  <style>
...
class FsYoutubePlayer extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.appendChild(interactiveVideoTemplate.content.cloneNode(true));
  }
...
//# sourceMappingURL=fs-youtube-player.js.map
